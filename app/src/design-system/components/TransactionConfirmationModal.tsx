            ...
            >
              ...
              <div className="px-4 pb-4 space-y-3">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-xl font-semibold text-[#101010] bg-[#0FB0CE] hover:bg-[#3FC4DB] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                >
