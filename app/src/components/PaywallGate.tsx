...
export function PaywallGate({ requiredTier, currentTier, onNavigateToUpgrade, children, fallbackUI = 'lock' }: PaywallGateProps) {
  ...
  const tierColors = { pro: 'text-[#56be89]', elite: 'text-[#FFD700]' };
    ...
    return (
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="bg-[#171C15] border border-[#56be89]/20 rounded-2xl p-6 text-center max-w-sm">
  ...
  if (fallbackUI === 'banner') {
    return (
      <div>
        {children}
        <div className="mt-3 bg-gradient-to-r from-[#171C15] to-[#1A1A1A] border border-[#56be89]/20 rounded-xl p-4">
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="bg-[#56be89] text-[#0B0F0A] px-3 py-1.5 rounded-full text-[10px] font-black shrink-0 cursor-pointer hover:bg-white transition-colors"
            >
              Upgrade
            </button>
          </div>
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-[#0B0F0A]/60 backdrop-blur-sm rounded-xl">
        <div className="bg-[#171C15] border border-[#56be89]/20 rounded-2xl p-5 text-center">
